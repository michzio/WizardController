//
//  UIWizardPageTableViewController.swift
//  WizardController
//
...
open class UIWizardPageTableViewController: UITableViewController, UIWizardPageNavigable, UIWizardPageValidable {
    
    public var pageState: UIWizardPageState = .Unknown
